 ...
 */
public class MyCourseReviewActivity extends ListActivity {

    ListView reviewListView;
    private ParseQueryAdapter<Review> mainReviewAdapter;
    private MyCourseReviewAdapter reviewAdapter;
...
// Find the toolbar view inside the activity layout
        ...
        delegate.getSupportActionBar().setTitle("My Course Review List");
        ...
        reviewAdapter = new MyCourseReviewAdapter(this);
...
//                Toast.makeText(CollegeListActivity.this, "Navigation drawer!", Toast.LENGTH_SHORT).show();
                switch (position) {
                    case 0: {
                        Intent intent = new Intent(MyCourseReviewActivity.this, CollegeListActivity.class);
                        startActivity(intent);
                        break;
                    }
                    case 1: {
                        Intent intent = new Intent(MyCourseReviewActivity.this, SearchCourseListActivity.class);
                        startActivity(intent);
                        break;
                    }
                    case 2: {
    ...
    private void setUpReviewItems() {
        reviewListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(MyCourseReviewActivity.this, ReviewSingleItem.class);
