...
//                Toast.makeText(CollegeListActivity.this, "Navigation drawer!", Toast.LENGTH_SHORT).show();
                switch (position) {
                    ...
                    case 2: {
                        Intent intent = new Intent(CollegeSingleItem.this, FavouritesActivity.class);
                        startActivity(intent);
                        break;
                    }

                    case 3: {
                        Intent intent = new Intent(CollegeSingleItem.this, MyReviewsActivity.class);
                        startActivity(intent);
                        break;
                    }
                    default:
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_report: {
                Intent intent = new Intent(CollegeSingleItem.this, NewReportActivity.class);
