 ...
 */
public class FavouriteClubSocReviewActivity extends ListActivity {

    ListView reviewListView;
    private ParseQueryAdapter<Favourite> mainReviewAdapter;
    private FavouriteClubSocReviewAdapter reviewAdapter;
...
// Find the toolbar view inside the activity layout
        ...
        delegate.getSupportActionBar().setTitle("Favourite Club/Society Review List");
        ...
        reviewAdapter = new FavouriteClubSocReviewAdapter(this);
...
//                Toast.makeText(CollegeListActivity.this, "Navigation drawer!", Toast.LENGTH_SHORT).show();
                switch (position) {
                    case 0: {
                        Intent intent = new Intent(FavouriteClubSocReviewActivity.this, CollegeListActivity.class);
                        startActivity(intent);
                        break;
                    }
                    case 1: {
                        Intent intent = new Intent(FavouriteClubSocReviewActivity.this, SearchCourseListActivity.class);
                        startActivity(intent);
                        break;
                    }
                    case 2: {
                        Intent intent = new Intent(FavouriteClubSocReviewActivity.this, FavouritesActivity.class);
                        startActivity(intent);
                        break;
                    }

                    case 3: {
                        Intent intent = new Intent(FavouriteClubSocReviewActivity.this, MyReviewsActivity.class);
                        startActivity(intent);
                        break;
                    }
                    default:
    ...
    private void setUpReviewItems() {
        reviewListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(FavouriteClubSocReviewActivity.this, ReviewSingleItem.class);
