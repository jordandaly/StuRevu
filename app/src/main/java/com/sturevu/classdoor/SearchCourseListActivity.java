...
//                Toast.makeText(CollegeListActivity.this, "Navigation drawer!", Toast.LENGTH_SHORT).show();
                switch (position) {
                    ...
                    case 2: {
                        Intent intent = new Intent(SearchCourseListActivity.this, FavouritesActivity.class);
                        startActivity(intent);
                        break;
                    }

                    case 3: {
                        Intent intent = new Intent(SearchCourseListActivity.this, MyReviewsActivity.class);
                        startActivity(intent);
                        break;
                    }
                    default:
    ...
    protected void onResume() {
        ...
        advancedSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent advancedSearchIntent = new Intent(SearchCourseListActivity.this, AdvancedSearchListActivity.class);
