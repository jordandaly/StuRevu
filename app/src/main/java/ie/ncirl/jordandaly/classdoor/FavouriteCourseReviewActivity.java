 ...
 */
public class FavouriteCourseReviewActivity extends ListActivity {


    ListView reviewListView;
    private ParseQueryAdapter<Favourite> mainReviewAdapter;
    private FavouriteCourseReviewAdapter reviewAdapter;
...
// Find the toolbar view inside the activity layout
        ...
        reviewAdapter = new FavouriteCourseReviewAdapter(this);
...
//                Toast.makeText(CollegeListActivity.this, "Navigation drawer!", Toast.LENGTH_SHORT).show();
                switch (position) {
                    case 0: {
                        Intent intent = new Intent(FavouriteCourseReviewActivity.this, CollegeListActivity.class);
                        startActivity(intent);
                        break;
                    }
                    case 1: {
                        Intent intent = new Intent(FavouriteCourseReviewActivity.this, SearchCourseListActivity.class);
                        startActivity(intent);
                        break;
                    }

                    case 2: {
                        Intent intent = new Intent(FavouriteCourseReviewActivity.this, FavouriteCollegeActivity.class);
                        startActivity(intent);
                        break;
                    }

                    case 3: {
                        Intent intent = new Intent(FavouriteCourseReviewActivity.this, FavouriteCourseActivity.class);
                        startActivity(intent);
                        break;
                    }

                    case 4: {
                        Intent intent = new Intent(FavouriteCourseReviewActivity.this, FavouriteCollegeReviewActivity.class);
                        startActivity(intent);
                        break;
                    }

                    case 5: {
                        Intent intent = new Intent(FavouriteCourseReviewActivity.this, FavouriteCourseReviewActivity.class);
                        startActivity(intent);
                        break;
                    }
                    case 6: {
                        Intent intent = new Intent(FavouriteCourseReviewActivity.this, MyCollegeReviewActivity.class);
                        startActivity(intent);
                        break;
                    }
                    case 7: {
                        Intent intent = new Intent(FavouriteCourseReviewActivity.this, MyCourseReviewActivity.class);
                        startActivity(intent);
                        break;
                    }
                    default:
